...
import { ADynamicFormField } from '../dynamic-field/dynamic-form-field.class';

export abstract class CustomFormFieldContentComponent implements OnInit, OnDestroy {
     ...
     */
    protected timeout(name: string, fn: () => void, delay: number = 300): void {
